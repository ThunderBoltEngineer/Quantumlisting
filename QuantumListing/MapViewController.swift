...
class MapViewController: UIViewController ,CLLocationManagerDelegate, MKMapViewDelegate,UITableViewDataSource,UITableViewDelegate, UISearchResultsUpdating, UISearchControllerDelegate, UISearchBarDelegate{
    ...
    @objc func geocodeFromTimer(_ timer: Timer) {
...
//        })
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.detailTextLabel?.text = address?.joined(separator: ", ")
    ...
    func updateSearchResults(for searchController: UISearchController) {
        ...
        searchTimer = Timer.scheduledTimer(timeInterval: kSearchDelay, target: self, selector: #selector(geocodeFromTimer), userInfo: userInfo, repeats: false)
